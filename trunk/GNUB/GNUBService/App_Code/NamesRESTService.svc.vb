...
Public Class NamesRESTService
    ...
    Protected Function GetCsvAll() As Message
        ...
        Try
            ...
            Dim folder As String = IO.Path.Combine(System.Configuration.ConfigurationManager.AppSettings.Get("webFolder"), "tmpCsv")

            Dim csvFile As String = GNUBBusinessRules.TaxonNameUsage.GetAllTNUDwC(folder, dt)
            ...
            If csvFile = "" Then
                ...
                rsp.Properties(HttpResponseMessageProperty.Name) = p
            Else
                rsp = Message.CreateMessage(MessageVersion.None, "*", New TextBodyWriter(IO.File.ReadAllText(csvFile)))
