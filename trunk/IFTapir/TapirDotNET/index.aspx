<%@ Page language="c#" Codebehind="index.aspx.cs" AutoEventWireup="True" Inherits="TapirDotNET.index" %>
	<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "DTD/xhtml1-transitional.dtd">
	<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	<title>TapirDotNET data provider</title>
	<style type="text/css">
	...
	<body>
	<h3><i>TapirDotNET data provider</i></h3>
	<p>TapirDotNET provides accesspoints that conform to the <a href = "http://rs.tdwg.org/tapir/">TAPIR</a> protocol. Each accesspoint is a separate service that can be used to programatically query one of the underlying resources (a local data source exposed to a federated network).</p>
	
	<h3>Resources</h3>
	<p>Interaction with this service can only be done through one of the active resources:</p>
	
	<asp:PlaceHolder ID="label1" Runat=server></asp:PlaceHolder>
	
	<h3>TAPIR parameters</h3>
	<p>The following KVP (key-value pair) parameters can be used to interact with a TAPIR accesspoint using HTTP POST or GET. You can also try the built-in <a href = "tapir_client.aspx">client interface</a> for full XML interaction. For more information about the parameters you can also check the <a href = "http://www.tdwg.org/dav/subgroups/tapir/1.0/docs/">TAPIR specification</a>.</p>
	<table>
