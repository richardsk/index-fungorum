...
elseif strType = "5" then
	...
	elseif strType = "1" then
		strSQL = "SELECT IndexFungorum.*, IndexFungorum_1.AUTHORS AS [CURRENT NAME AUTHORS], " _
			...
			& "WHERE (((IndexFungorum.[NAME OF FUNGUS]) Like '" & protectSQL(strSearchName, false) & "%') AND ((IndexFungorum.[GSD FLAG]) Like 'GSD%')) " _
			& "OR (((IndexFungorum.[NAME OF FUNGUS]) Like '" & protectSQL(strSearchName, false) & "%') AND ((IndexFungorum.[TAXONOMIC REFEREE]) Is Not Null)) " _
