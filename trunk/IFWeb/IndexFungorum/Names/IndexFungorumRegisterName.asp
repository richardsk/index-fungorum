...
<%
	...
	elseif strn(Request.Form("Act")) = "New genus" then
		...
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			...
			& "ORDER BY tblNomenclaturalActs.ID;"
		strText = ""
	elseif strn(Request.Form("Act")) = "New subgenus" then
		strText = "New subgenus"
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			& "FROM tblNomenclaturalActs " _
			& "WHERE (((tblNomenclaturalActs.NomenclaturalAct) LIKE '" & protectSQL(strText, false) & "%')) " _
			& "ORDER BY tblNomenclaturalActs.ID;"
		strText = ""
	elseif strn(Request.Form("Act")) = "New section" then
		strText = "New section"
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			& "FROM tblNomenclaturalActs " _
			& "WHERE (((tblNomenclaturalActs.NomenclaturalAct) LIKE '" & protectSQL(strText, false) & "%')) " _
			& "ORDER BY tblNomenclaturalActs.ID;"
		strText = ""
	elseif strn(Request.Form("Act")) = "New subsection" then
		strText = "New subsection"
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			& "FROM tblNomenclaturalActs " _
			& "WHERE (((tblNomenclaturalActs.NomenclaturalAct) LIKE '" & protectSQL(strText, false) & "%')) " _
			& "ORDER BY tblNomenclaturalActs.ID;"
		strText = ""
	elseif strn(Request.Form("Act")) = "New series" then
		strText = "New series"
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			& "FROM tblNomenclaturalActs " _
			& "WHERE (((tblNomenclaturalActs.NomenclaturalAct) LIKE '" & protectSQL(strText, false) & "%')) " _
			& "ORDER BY tblNomenclaturalActs.ID;"
		strText = ""
	elseif strn(Request.Form("Act")) = "New subseries" then
		strText = "New subseries"
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			& "FROM tblNomenclaturalActs " _
			& "WHERE (((tblNomenclaturalActs.NomenclaturalAct) LIKE '" & protectSQL(strText, false) & "%')) " _
			& "ORDER BY tblNomenclaturalActs.ID;"
		strText = ""
	elseif strn(Request.Form("Act")) = "New infrageneric taxon" then
		strText = "New infrageneric taxon"
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			& "FROM tblNomenclaturalActs " _
			& "WHERE (((tblNomenclaturalActs.NomenclaturalAct) LIKE '" & protectSQL(strText, false) & "%')) " _
			& "ORDER BY tblNomenclaturalActs.ID;"
	...
	elseif strn(Request.Form("Act")) = "New subfamily" then
		...
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			...
			& "ORDER BY tblNomenclaturalActs.ID;"
		strText = ""
	elseif strn(Request.Form("Act")) = "New infrafamilial name" then
		strText = "New infrafamilial name"
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			& "FROM tblNomenclaturalActs " _
			& "WHERE (((tblNomenclaturalActs.NomenclaturalAct) LIKE '" & protectSQL(strText, false) & "%')) " _
			& "ORDER BY tblNomenclaturalActs.ID;"
	...
	elseif strn(Request.Form("Act")) = "New order" then
		...
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			...
			& "ORDER BY tblNomenclaturalActs.ID;"
		strText = ""
	elseif strn(Request.Form("Act")) = "New suborder" then
		strText = "New suborder"
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			& "FROM tblNomenclaturalActs " _
			& "WHERE (((tblNomenclaturalActs.NomenclaturalAct) LIKE '" & protectSQL(strText, false) & "%')) " _
			& "ORDER BY tblNomenclaturalActs.ID;"
	...
	elseif strn(Request.Form("Act")) = "New class" then
		...
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			...
			& "ORDER BY tblNomenclaturalActs.ID;"
		strText = ""
	elseif strn(Request.Form("Act")) = "New subclass" then
		strText = "New subclass"
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			& "FROM tblNomenclaturalActs " _
			& "WHERE (((tblNomenclaturalActs.NomenclaturalAct) LIKE '" & protectSQL(strText, false) & "%')) " _
			& "ORDER BY tblNomenclaturalActs.ID;"
	...
	elseif strn(Request.Form("Act")) = "New phylum" then
		...
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			...
			& "ORDER BY tblNomenclaturalActs.ID;"
		strText = ""
	elseif strn(Request.Form("Act")) = "New subphylum" then
		strText = "New subphylum"
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			& "FROM tblNomenclaturalActs " _
			& "WHERE (((tblNomenclaturalActs.NomenclaturalAct) LIKE '" & protectSQL(strText, false) & "%')) " _
			& "ORDER BY tblNomenclaturalActs.ID;"
		strText = ""
	elseif strn(Request.Form("Act")) = "New suprafamilial name" then
		strText = "New suprafamilial name"
		strSQL = "SELECT tblNomenclaturalActs.NomenclaturalAct " _
			& "FROM tblNomenclaturalActs " _
			& "WHERE (((tblNomenclaturalActs.NomenclaturalAct) LIKE '" & protectSQL(strText, false) & "%')) " _
			& "ORDER BY tblNomenclaturalActs.ID;"
	...
	if not RS.bof then
		...
		response.write("<OPTION>New suprafamilial name</OPTION>")
		...
		response.write("<OPTION>New typification</OPTION>")
			...
			strPopup = "<a href='" & strJava & "IndexFungorumRegistrationHelp.htm" & strStr & "'><img src='../IMAGES/i.gif' alt='Help with registration' width='13' height='13' border='0'></a>"
...
'New species
		...
		if RS1.RecordCount > 0 then
			...
			do while not RS1.eof
				response.write("<option value='" & encodeHtml(RS1("pubLink")) & "'>" & encodeHtml(RS1("pubIMIAbbr")) & "</option>")
				RS1.MoveNext
			loop
		end if
		RS1.close
		...
		if RS1.RecordCount > 0 then
			...
			response.write("<option value=''></option>")
			do while not RS1.eof
				response.write("<option value='" & encodeHtml(RS1("IFcountry")) & "'>" & encodeHtml(RS1("DisplayCountry")) & "</option>")
				RS1.MoveNext
			loop
		end if
		RS1.close
		...
		response.write("<td width='80%'><textarea type=text value='' name=Comments id=comment cols='68' rows='5'></textarea></td>")
		response.write("</tr>")
...
'New subspecies
		...
		if RS1.RecordCount > 0 then
			...
			response.write("<option value=''></option>")
			do while not RS1.eof
				response.write("<option value='" & RS1("pubLink") & "'>" & encodeHtml(RS1("pubIMIAbbr")) & "</option>")
				RS1.MoveNext
			loop
		end if
		RS1.close
...
'New infraspecific taxon
		...
		response.write("<td width='80%'><input type=text value='' name=Rank id=Rank size='40' maxlength='100'>")
		response.write("</tr>")
		...
		if RS1.RecordCount > 0 then
			...
			response.write("<option value=''></option>")
			do while not RS1.eof
				response.write("<option value='" & RS1("IFcountry") & "'>" & encodeHtml(RS1("DisplayCountry")) & "</option>")
				RS1.MoveNext
			loop
		end if
		RS1.close
...
'New subgenus, section, subsection, series, subseries, infrageneric name
		elseif strText = "New subgenus" or strText = "New section" or strText = "New subsection" or strText = "New series" or strText = "New subseries" or strText = "New infrageneric taxon" then
		response.write("<table width='60%' align='center' border='1' cellpadding='2' class='mainbody'>")
		response.write("<tr>")
		response.write("<td width='20%'><span class=label>&nbsp;</span></td>")
		response.write("<td width='80%'><b><span class=label>Registering a new subgenus, section, subsection, series, subseries, other infrageneric rank</span></b></td>")
		response.write("</tr>")
...
'New family
		...
		response.write("<tr>")
		response.write("<td width='20%'>Type genus</td>")
		...
		if RS1.RecordCount > 0 then
			...
			response.write("<option value=''></option>")
			do while not RS1.eof
				response.write("<option value='" & RS1("Fundic Record Number") & "'>" & encodeHtml(RS1("Genus name")) & "</option>")
				RS1.MoveNext
			loop
		end if
		RS1.close
...
'New subfamily, or other infrafamilial name
		elseif strText = "New subfamily" or strText = "New infrafamilial name" then
		response.write("<table width='60%' align='center' border='1' cellpadding='2' class='mainbody'>")
		response.write("<tr>")
		response.write("<td width='20%'><span class=label>&nbsp;</span></td>")
		response.write("<td width='80%'><b><span class=label>Registering a new subfamily or infrafamilial name</span></b></td>")
		response.write("</tr>")
...
'New suborder, or new subclass, or new subphylum, or new suprafamilial name
		elseif strText = "New suborder" or strText = "New subclass" or strText = "New subphylum" or strText = "New suprafamilial name" then
		response.write("<table width='60%' align='center' border='1' cellpadding='2' class='mainbody'>")
		response.write("<tr>")
		response.write("<td width='20%'><span class=label>&nbsp;</span></td>")
		response.write("<td width='80%'><b><span class=label>Registering a new suborder, subclass, subphylum, suprafamilial name</span></b></td>")
		response.write("</tr>")
...
'New combination
		...
		response.write("<td width='80%'><input type=text value='' name=Basionym id=Basionym size='6' maxlength='6'>&nbsp;" & strPopup)
		response.write("</tr>")
		...
		response.write("<tr>")
		response.write("<td width='20%'><span class=label>Comment</span></td>")
		response.write("<td width='80%'><textarea type=text value='' name=Comment id=comment cols='68' rows='5'></textarea></td>")
		response.write("</tr>")
...
'New name
		...
		response.write("<td width='80%'><input type=text value='' name=ReplacedSynonym id=ReplacedSynonym size='6' maxlength='6'>&nbsp;" & strPopup)
		response.write("</tr>")
		...
		response.write("<td width='80%'><input type=text value='' name=CompetingSynonym id=CompetingSynonym size='6' maxlength='6'>&nbsp;" & strPopup)
		response.write("</tr>")
...
'register new typification		
		...
		response.write("<tr>")
		response.write("<td width='20%'><span class=label>IF number of name to be typified</span></td>")
		strStr = chr(34) & chr(41)
		strJava = "javascript:popUp(" & chr(34)
