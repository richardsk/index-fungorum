...
<html>
<head>
<title>Index Fungorum - Insert Updated Record</title>
...
<table width="100%" height="100%" class="mainbody">
  ...
  <tr> 
	...
	dim RS, StrSQL, intPubLink, strDate, strEmail
	...
	strRecordNumber = session("strRecordNumber")
		...
		Response.Write("<tr>")
		Response.write("<td colspan='2' align='center'>You are ready to update <b><font color='#FF0000'>" & session("strNameOfFungus") & " " & session("strAuthor") & " " & session("strYearOfPublication"))
	...
	if not IsEmpty(Request.Form("btnTest")) then
		...
		if TestCaptcha("ASPCAPTCHA", Request.Form("captchacode")) then
			...
			dbConn.close
			set dbConn = Nothing
			response.Redirect("IndexFungorumUpdateNameEmailer.asp")
		else
