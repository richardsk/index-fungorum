...
sub DisplayRecord()
   ...
   response.write("<td width='85%'><input type=text value='' id=Name size='80' maxlength='100'>")
   response.write("<div class=error id=NameError>Required: Please enter the name</div></td>")
   response.write("</tr>")

   response.write("<tr>")
   response.write("<td width='15%'><span class=label>Author</span></td>")
   response.write("<td width='85%'><input type=text value='' id=author size='80' maxlength='100'>")
   ...
   response.write("<td width='85%'><input type=text value='' id=publishingauthors size='80' maxlength='100'></td>")
   response.write("</tr>")

   response.write("<tr>")
   response.write("<td width='15%'><span class=label>PubAcceptedTitle</span></td>")
   response.write("<td width='85%'><input type=text value='' id=pubacceptedtitle size='80' maxlength='100'></td>")
   response.write("</tr>")

   response.write("<tr>")
   response.write("<td width='15%'><span class=label>Volume</span></td>")
   response.write("<td width='85%'><input type=text value='' id=volume size='80' maxlength='100'></td>")
   response.write("</tr>")

   response.write("<tr>")
   response.write("<td width='15%'><span class=label>Part</span></td>")
   response.write("<td width='85%'><input type=text value='' id=part size='80' maxlength='100'></td>")
   response.write("</tr>")

   response.write("<tr>")
   response.write("<td width='15%'><span class=label>Page</span></td>")
   response.write("<td width='85%'><input type=text value='' id=page size='80' maxlength='100'>")
   ...
   response.write("<td width='85%'><input type=text value='' id=YearOfPublication size='80' maxlength='100'>")
   ...
   response.write("<td width='85%'><input type=text value='' id=YearOnPublication size='80' maxlength='100'></td>")
   response.write("</tr>")
   response.write("<tr>")
   response.write("<td width='15%'><span class=label>Synonymy</span></td>")
   response.write("<td width='85%'><input type=text value='' id=synonymy size='80' maxlength='100'></td>")
   response.write("</tr>")
   response.write("<tr>")
   response.write("<td width='15%'><span class=label>Host or Substratum</span></td>")
   response.write("<td width='85%'><input type=text value='' id=host size='80' maxlength='100'></td>")
   response.write("</tr>")
   response.write("<tr>")
   response.write("<td width='15%'><span class=label>Country of origin of type</span></td>")
   response.write("<td width='85%'><input type=text value='' id=location size='80' maxlength='100'></td>")
   response.write("</tr>")

   response.write("<tr>")
   response.write("<td width='15%'><span class=label>Typification details</span></td>")
   response.write("<td width='85%'><input type=text value='' id=TypificationDetails size='80' maxlength='100'>")
   ...
   response.write("<td width='85%'><input type=text value='' id=email size='80' maxlength='100'>")
   ...
   response.write("<td width='85%'><textarea type=text value='' id=comment cols='67' rows='5'></textarea></td>")
   response.write("</tr>")
