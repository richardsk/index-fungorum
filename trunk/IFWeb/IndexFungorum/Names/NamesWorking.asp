	...
	elseif strIP = "127.0.0.1" then
	   ...
	   dbConn.open "FILEDSN=cabilink"
		...
		elseif strType = "E" then
			strSQL = "SELECT IndexFungorum.* FROM IndexFungorum " _
				& "WHERE (((IndexFungorum.[SPECIFIC EPITHET]) Like '" & protectSQL(strSearch, true) & "%') AND ((IndexFungorum.[STS FLAG])= 'o')) " _
				& "OR (((IndexFungorum.[INFRASPECIFIC EPITHET]) Like '" & protectSQL(strSearch, true) & "%') AND ((IndexFungorum.[STS FLAG])= 'o')) " _
