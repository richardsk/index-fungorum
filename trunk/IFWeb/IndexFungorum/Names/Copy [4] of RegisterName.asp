...
response.write(session("strNameOfFungus") & "&nbsp;is the name<br>")
...
response.write(strAddedBy & "&nbsp;is the email<br>")
		...
		Response.Write("<tr>")
		Response.Write("<td colspan='2' align='center'><strong>CAPTCHA Example</strong></td>")
		Response.Write("</tr>")
		Response.Write("<tr>")
		Response.Write("<td width='261'>CAPTCHA Image</td>")
		Response.Write("<td width='123'><img id='imgCaptcha' src='captcha.asp' /><br /><a href='javascript:void(0)' onclick='RefreshImage('imgCaptcha')'>Change Image</a></td>")
		Response.Write("</tr>")
		Response.Write("<tr>")
		...
		Response.Write("<td><input type='submit' name='btnTest' id='btnTest' value='Test Input' /></td>")
		Response.Write("</tr>")
...
response.write("<br>" & session("strNameOfFungus") & "&nbsp;is the name<br>")
		...
		strSQL = strSQL & "('" & session("strNameOfFungus") & "', '" & strAuthors & "', '" & strOrthographyComment & "', '" _
