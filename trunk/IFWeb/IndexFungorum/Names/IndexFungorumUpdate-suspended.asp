    ...
    <td align="left" valign="top"><table width="100%" cellpadding="5">
        <tr>
          <td><!-- InstanceBeginEditable name="head" -->
            <!-- InstanceEndEditable --><!-- InstanceBeginEditable name="Main" -->This 
            service has been temporarily suspending pending upgrades. If you have 
            new or missing data please email <a href="mailto:p.kirk@cabi.org">Paul 
            Kirk</a> <!-- InstanceEndEditable --></td>
        </tr>
      </table></td>
  </tr>
  <tr>
