...
namespace Utility
{
	...
	public class OrderedMap : System.Collections.Specialized.NameObjectCollectionBase
	{
		...
		/// Eg, <code>arr.SetValue("value", 1, 3, 4, 6);</code>.</param>
			...
			try
			{
				switch (messageType)
				{
					...
					case 3:
						...
						System.Diagnostics.EventLog.WriteEntry("TapirDotNET Application", message, System.Diagnostics.EventLogEntryType.Error);
						break;
					default:	//1
						System.Web.Mail.SmtpMail.SmtpServer = destination.Substring(destination.LastIndexOf("@") + 1);
						System.Web.Mail.SmtpMail.Send("from", destination, "TapirDotNET error_log message", message);
						break;
				}
				result = 1;
			}
