...
#Region " Web Services Designer Generated Code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        '
        Me.SqlCon_IndexFungorum.ConnectionString = "data source=INDEXFUNGORUM;initial catalog=IndexFungorum;password=WSUser;persist secur" & _
        "ity info=True;user id=WSUSer;packet size=4096"
        '
        'SqlDa_EpithetSearch
        '
...
#End Region
    ...
    <WebMethod()> Public Function NameByKeyDs(ByVal NameKey As Long) As DataSet
        ...
        Dim QueryString As String
        QueryString = "SELECT IndexFungorum.*, Publication.*,FundicClassification.* " _
