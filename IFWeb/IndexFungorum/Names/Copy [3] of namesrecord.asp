      ...
      <table width="100%" border="0" class="mainbody">
        <tr> 
          ...
          <td valign="top"> <table height="100%" align="center">
              ...
              <tr class="mainbody"> 
                <td><a href="AuthorsOfFungalNames.asp" onMouseOver="MM_displayStatusMsg('Search Authors of Fungal Names');return document.MM_returnValue" onMouseout="MM_displayStatusMsg('');return document.MM_returnValue">Search Authors of Fungal Names</a></td>
              </tr>
              <tr class="mainbody"> 
                <td><a href="Names.asp" onMouseOver="MM_displayStatusMsg('Search Index Fungorum');return document.MM_returnValue" onMouseout="MM_displayStatusMsg('');return document.MM_returnValue">Search Index Fungorum</a></td>
              </tr>
              <tr class="mainbody">
...
sub DisplayLinkedData(rs, strShow)
			...
			strCommentType = left(strn(rs("NOMENCLATURAL COMMENT")), 13)
				...
				if strData4 <> "" then
					...
					if instr(strCommentType,"illegit") then
						if strData2 <> "" then 
							response.write("<p><b>Editorial comment: </b><br>A homonym of " & strLink & " non " & strLink2 & ". " & strData2 & "</p>")
						else
							response.write("<p><b>Editorial comment: </b><br>A homonym of " & strLink & " non " & strLink2 & "</p>")
						end if
					...
					if instr(strCommentType,"illegit") then
						if strData2 <> "" then 
							response.write("<p><b>Editorial comment: </b><br>A homonym of " & strLink & ". " & strData2 & "</p>")
						else
							response.write("<p><b>Editorial comment: </b><br>A homonym of " & strLink & "</p>")
						end if
					elseif instr(strCommentType,"inval") then
						if strData2 <> "" then 
							response.write("<p><b>Editorial comment: </b><br>See " & strLink & ". " & strData2 & "</p>")
		...
		if strData <> "" then
			if left(strData,13) = "Holotype IMI " then
				...
				if instr(strData," ") then strData = left(strData,instr(strData," "))
 				strLink = "http://www.herbIMI.info/DisplayResults.asp?strIMINumber=" & strData
	...
	if left(rs("CORRECTION"),2) = "$N" then
		...
		strPageImage = replace(strPageImage,"194.203.77.76/librifungorum","www.librifungorum.org")
