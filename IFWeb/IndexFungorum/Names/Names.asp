            ...
            <form method="post" action="Names.asp" name="search">
              <table width="651" border="0" name="Names" height="60">
                <tr> 
                  ...
                  <td colspan="4" align="right"><a href="IndexFungorumRegister.htm"><img src="../IMAGES/news.gif" alt="register and publish names with a few mouse clicks" width="32" height="16" border="0" align="left"></a> 
<%
