...
'			& "WHERE (((tblRegistrationUsers.UUID) = '" & strUUID & "'));"

		strSQL = "UPDATE IndexFungorum SET IndexFungorum.[CURRENT NAME RECORD NUMBER] = Null, IndexFungorum.[STS FLAG] = Null, IndexFungorum.[LAST FIVE YEARS FLAG] = Null " _
			& "WHERE (((IndexFungorum.[RECORD NUMBER])='550000' Or (IndexFungorum.[RECORD NUMBER])='550008' Or (IndexFungorum.[RECORD NUMBER])='122180'));"
		...
		Response.Write("<b><font color='#0000FF'>records have been updated</font></b><br>")
end sub
%>
<%
	ActivateUser()
