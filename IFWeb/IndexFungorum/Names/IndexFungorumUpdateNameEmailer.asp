...
<html>
<head>
<title>Index Fungorum - UpdateNameEmailer</title>
...
<table width="100%" height="100%" class="mainbody">
  ...
  <tr> 
	...
	objEmail.Subject = "Index Fungorum Name Update"
	Body = "Name updated details" & vbCrLf & vbCrLf
	Body = Body & "Name updated: " & strNameDetails & vbCrLf & vbCrLf
...
'	objEmail.HTMLBody = Body
	...
	Set objEmail = Nothing
		...
		response.write("<h3><font color='#FF0000'>Index Fungorum addition/update</font></h3><br>")
		...
		Response.write("<a href='../Names/Names.asp'>seach for another name</a>")
		'Clear the session
		Session.Abandon
